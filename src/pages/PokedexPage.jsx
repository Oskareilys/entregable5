  ...
  return (
    <div className="pokedex">
      <header className="pokedex__header">
        ...
        <Link to="/">
          <img
            className="pokedex__img__header"
            src="./Pokedexheader.png"
            alt=""
          />
        </Link>
      </header>
